...
<body class="">
    ...
    <div class="max-w-sm flex flex-col  mx-auto bg-tertiary-blue min-h-screen shadow-lg">

        <!-- hider gambar gatau gambar aoaan -->
        <div class="relative w-full flex-1 bg-tertiary-blue">
            <img src=""
                alt="header img" class="w-full h-full object-cover">

        </div>

        <div class="p-6 bg-primary-white flex-1 h-full rounded-tl-3xl rounded-tr-3xl">

            <h1 class="text-6xl font-semibold text-center">BacaIn</h1>
